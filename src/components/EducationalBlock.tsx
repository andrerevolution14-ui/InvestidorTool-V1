...
const WA_MSG = encodeURIComponent("Olá, completei a simulação e quero saber mais sobre oportunidades em Aveiro.");
...
export default function EducationalBlock() {
    const fails = [
        "Compram caro — sem análise real do valor nem da zona",
    ...
    return (
        <section className="content-block" id="education">
            <div className="content-block-inner">
                <div className="animate-fade-in-up">
                    <h2 className="section-title">
                        ⚠️ Porque é que a maioria <span style={{ color: "#e85d5d" }}>perde dinheiro</span> em imobiliário
                    </h2>
                </div>
                ...
                <div className="cta-block animate-fade-in-up">
                    <p className="cta-micro">💡 Quer saber como evitar estes erros e investir com segurança?</p>
                    <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="btn-whatsapp" id="btn-wa-edu">
